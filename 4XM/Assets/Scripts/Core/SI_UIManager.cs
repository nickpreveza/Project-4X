...
public class SI_UIManager : MonoBehaviour
{
    ...
    { 
        ...
        else
        {
            ...
            targetPanel.Disable();
            SI_GameManager.Instance.menuActive = false;
            HideTooltip();
        }
    }
    ...
    {
        if (SI_GameManager.Instance.isPaused)
        {
            gamePanel.canvasGroup.alpha = 0;
            pausePanel.Activate();
        }
    ...
    {
        Application.OpenURL(SI_GameManager.Instance.data.itchURL);
    }

    public void ActionOpenWebsite()
    {
        Application.OpenURL(SI_GameManager.Instance.data.websiteURL);
    }

    public void ActionOpenDiscord()
    {
        Application.OpenURL(SI_GameManager.Instance.data.discordURL);
    }
